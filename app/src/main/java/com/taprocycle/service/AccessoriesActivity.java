...
public class AccessoriesActivity extends AppCompatActivity implements SwipeRefreshLayout.OnRefreshListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        txt_titile.setText("All Products");
        ...
        wislist.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent=new Intent(AccessoriesActivity.this,WishlistActivity.class);
                startActivity(intent);
            }
        });
        search.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent=new Intent(AccessoriesActivity.this, SearchActivity.class);
                startActivity(intent);
            }
        });
    ...
    public void onRefresh() {
        new Handler(Looper.getMainLooper()).postDelayed(new Runnable() {
            @Override
            public void run() {
                Toast.makeText(AccessoriesActivity.this, "Refreshed!", Toast.LENGTH_SHORT).show();
                accesories();
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    if (jsonResponse.has("result") && jsonResponse.getString("result").equals("Success")) {
                        ...
                        LinearLayoutManager layoutManager = new LinearLayoutManager(AccessoriesActivity.this, LinearLayoutManager.VERTICAL, false);
                        rv_products.setLayoutManager(layoutManager);
                        productListAdapter = new RecentlyAdapter(AccessoriesActivity.this, recentlyaddedwiselist);
