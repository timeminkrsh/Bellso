...
/*
public class RelatedAdapter extends RecyclerView.Adapter<RelatedAdapter.MailViewHolder> {
    ...
    public RelatedAdapter(Context mContext, List<ProductsModel> bannerlist) {
...
public class RelatedAdapter extends RecyclerView.Adapter<RelatedAdapter.MailViewHolder> {
    ...
    List<ProductsModel> bannerlist = new ArrayList<>();
    private Context mContext;
    AlertDialog dialog;
    String pid;
    ...
    @NonNull
    @Override
    public RelatedAdapter.MailViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.related_products, parent, false);
        return new MailViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull final RelatedAdapter.MailViewHolder holder, @SuppressLint("RecyclerView") final int position) {
        final ProductsModel model = bannerlist.get(position);
        String img = bannerlist.get(position).getImage();
