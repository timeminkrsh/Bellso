...
public class NoticeBoard {
    private String shortt,pan_number,date,balance,description,banner_image,name,bank,branch,ifsc,title,account,req,tdate,amount,net_amount,tds_amount,adesc;
